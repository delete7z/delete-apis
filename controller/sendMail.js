...
module.exports.sendResetEmail = async (email, token) => {
  ...
  await smtpTransport.sendMail({
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0;">
                    Problema ao fazer login?<br>Redefinir sua senha é fácil.<br><br>Basta pressionar o botão abaixo e seguir as instruções. Nós o colocaremos em funcionamento rapidamente.</p>
                </td>
              </tr>
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                  <p style="margin: 0;">delete<br> ${domain}</p>
                </td>
              </tr>
    ...
    if (error) {
      resolve('error')
      console.log(`Aviso de erro SMTP, limite expirado.`);
    } else{
      resolve()
    }
  });
        ...
        <tr>
          <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0;">Obrigado por usar delete apis. Pressione o botão abaixo para verificar sua conta.</p>
                </td>
              </tr>
        ...
        <tr>
          <td align="center" bgcolor="#e9ecef" style="padding: 24px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                  <p style="margin: 0;">Você está recebendo este e-mail porque recebemos uma solicitação de verificação de conta para sua conta. Se você não solicitar a verificação da conta, poderá excluir este e-mail com segurança.</p>
                </td>
              </tr>
